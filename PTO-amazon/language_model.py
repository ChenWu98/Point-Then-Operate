...
from LM.dataloaders.amazon import Amazon
...
class LanguageModel(object):
    ...
    def build(self):
        ...
        self.train_set = Amazon('train', False, config.sentiment, config.direction)
        self.test_set = Amazon('test', False, config.sentiment, config.direction)
        self.val_set = Amazon('dev', False, config.sentiment, config.direction)
