...
## Dependencies
* Python 3.6.5
* Versions of all depending libraries are specified in `requirements.txt`. To reproduce the reported results, please make sure that the specified versions are installed. **Update**: We receive a security vulnerability alert for the specified version of `nltk` from GitHub.
